...
// Created:     2011/06/23
// RCS-ID:      $Id: SVGCanvasTextCairo.cpp,v 1.3 2011-07-03 20:51:58 ntalex Exp $
...
void wxSVGCanvasTextCairo::InitText(const wxString& text, const wxCSSStyleDeclaration& style) {
	...
	m_char->bbox = wxSVGRect(m_tx + extents.x_bearing, m_ty + extents.y_bearing, extents.x_advance, extents.y_advance);
	m_tx += extents.x_advance;
}

void wxSVGCanvasTextCairo::SetFont(cairo_t* cr, const wxCSSStyleDeclaration& style) {
