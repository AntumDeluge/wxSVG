...
// Created:     2005/09/27
// RCS-ID:      $Id: SVGPathSegList.cpp,v 1.3 2005-11-06 17:34:53 ntalex Exp $
...
wxString wxSVGPathSegList::GetValueAsString()
{
  wxString value;
...
void wxSVGPathSegList::SetValueAsString(const wxString& value)
{
  ...
  while (val.Length())
  {
    ...
    while (val.Length())
    {
      ...
      unsigned int pos;
      if (val.Length()>0 && s_numericFirst.Contains(val.Left(1)))
      {
        pos = 1;
